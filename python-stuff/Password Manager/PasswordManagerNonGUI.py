...
if (data == currentVersion):
    ...
    newVersion = requests.get("https://github.com/obeywasabi/python-testing-grounds/blob/main/python-stuff/Password%20Manager/PasswordManagerNonGUI.exe?raw=true")
